...
<body>
  <div class="navigation-bar">
    ...
    <div class="greet">
      <a href="home.php">Hello, <?php echo ucfirst($first_name) ?></a>
    </div>


    <div id="nav-right">

      <a href="settings.php" class="material-symbols-outlined">
        settings
      </a>
      <form method="post" action="" style="height: 25px;">
        <button class="material-symbols-outlined" id="logout" type="submit" name="logout">
          logout
        </button>
      </form>
    </div>
