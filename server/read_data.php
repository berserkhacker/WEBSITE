...
try {
    ...
    $stmt = $db->prepare("SELECT user_id, username, first_name, middle_name,last_name, email, phone_num, secret_question, pwd, region FROM students WHERE username = :username");
